...
class OffPolicyRLModel(BaseRLModel):
    ...
    def is_using_her(self) -> bool:
        ...
        from stable_baselines.her.replay_buffer import HindsightExperienceReplayWrapper, DDLHindsightExperienceReplayWrapper
        return isinstance(self.replay_buffer, HindsightExperienceReplayWrapper) or isinstance(self.replay_buffer, DDLHindsightExperienceReplayWrapper)
